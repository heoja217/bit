/* Command 인터페이스를 제거하고 @Command 애노테이션을 사용하여 명령처리 클래스를 만듦.
  목표 :
  메서드에 애노테이션을 붙이는 방법
	...
	public void service() {
		...
		loop: while (true) {
			try {
				...
				Set<Method> methods = 
						ReflectionUtils.getMethods(command.getClass(), 
								ReflectionUtils.withAnnotation(java02.test09.annotation.Command.class)).getMethodsAnnotatedWith(java02.test09.annotation.Command.class);
