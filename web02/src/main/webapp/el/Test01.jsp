...
<ul>
	...
	<li>HttpServletResponse responce 파라미터 </li>
	<li>PageContext pageContest = ...;</li>
...
session					: HttpSession 			:${pageContext.session객체}
