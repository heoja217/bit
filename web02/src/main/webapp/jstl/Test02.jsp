...
pageScope.name1 = ${pageScope.name2}<br>
pateScope.name1 = ${pateScope.name3}<br>
...
${pageScope.name1}<br>
<%pageContext.removeArrivute("name1"); %>
제거한 후의 name1? ${pageScope.name1}<br>

<c:remove var="name2" scope="page"/>
제거한 후의 name2? ${pageScope.name2}<br>
